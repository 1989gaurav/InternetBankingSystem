...
/**
 * Servlet implementation class for Servlet: SendAccount
 *
 */
 public class SendAccount extends DBConnect implements javax.servlet.Servlet {
    	...
    	try
        {
            ...
            else
            {
                ...
                while(sendResult.next())
                {
                    ...
                    accountNumber = sendResult.getLong("accountNumber");
                    
                    if( isFirst )
                    {
                    	responsePacket = responsePacket + "{'id':"+count+",'acnum':'"+accountNumber+"'}";
                    	isFirst = false;
                    }
                    else
                    {
