  ...
  *
  */
  public class GetFavouriteList extends DBConnect implements javax.servlet.Servlet {
 	...
 	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
 		...
 		try
 		{
 			...
 			else
 			{
 				...
 				//htmlHead += "<body>		<img alt=\"Internet Banking System Logo\" src=\"images/header.png\" style=\"height: 95px; width: 956px\" />		<div style=\"width: 956px; background-color: #DDDDDD;\" id=\"quickBar\">		</div>		<div style=\"height: 500px; width: 950px\" id=\"container\">		</div>		<div id=\"west\">		</div>		<div id=\"quickArea\" class=\"x-hidden x-window x-window-plain x-resizable-pinned\" style=\"position: absolute; z-index: 9003; visibility: visible; left: 225px; top: 220px; width: 500px; display: block;\"></div>		<div id=\"quickArea1\" class=\"x-hidden x-window x-window-plain x-resizable-pinned\" style=\"position: absolute; z-index: 9003; visibility: visible; left: 225px; top: 220px; width: 500px; display: block;\"></div>		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color=\"black\" face=Arial size=2><u><b>copyright © 2008-09 Teenovators, All rights reserved</b></u></font>	</body></html>";
 				...
 				query = "select * from myFavorites where myFavorites.userID="+Userid;
 				rset=ExecuteQuery(query, stmt, true);
 				
 				/* now i need to make a packet in the form of [['Fav1'],['fav2'],....]
 				 * the statement outside the loop creates[['fav1],
 				 * the statement inside the loop creates ['fav2],['fav3'],...
 				 * and last statement outside loop add the trailing bracket
 				 */
